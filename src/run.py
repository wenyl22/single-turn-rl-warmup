...
if __name__ == "__main__":
    ...
    parser.add_argument('--format', type=str, default='A', choices=['A', 'AC', 'TA'], \
        help='format of the belief state generated by slow agent \
            (AS: action sequence, ASC: action sequence + conclusion, TA: thinking process + action sequence)')

    args = parser.parse_args()
    model = args.slow_model if args.slow_model != "" else args.fast_model
    logging_dir = f"logs-0613/{args.game}_{args.method}_{args.difficulty}/{model}"
